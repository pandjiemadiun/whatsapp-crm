...
7. **Test manual — curl webhook 2 turn ke store-f7140b5c (engine=v2)**
   ...
   - Turn 1 via Fonnte webhook `POST /api/webhooks/fonnte?secret=12b11e175e472db3e0a86ab422f86bc71e914c6eadc41a23` body `{"sender":"6282199911222","name":"Test User","message":"halo","device":"6289658888008","id":...}`.
