 ...
 */
export async function sendBackupFailureAlert(error: Error, context?: string): Promise<void> {
...
`;
    ...
    adapters.logger.error('(Mailer) Failed to send backup failure alert', msg as Error);
