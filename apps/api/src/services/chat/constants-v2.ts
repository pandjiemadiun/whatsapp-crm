...
export const ENGINE_VERSION: string = '3.2';
 ...
 */
export const SELECTION_CONFIDENCE_THRESHOLD: number = 0.6;
 ...
 */
export const CLARIFICATION_MAX_ATTEMPTS: number = 2;
 ...
 */
export const DEFERRED_AUTO_DROP_TURNS: number = 3;
