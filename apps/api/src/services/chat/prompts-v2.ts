...
// ─────────────────────────────────────────────────────────────────────────────
// History turn (didefinisikan lokal agar tidak menyentuh types-v2.ts)
// ─────────────────────────────────────────────────────────────────────────────
...
export const FEW_SHOTS: FewShotV2[] = [
  {
    ...
    context_description:
      'Customer order 3 produk sekaligus (multi-act). Semua product mention harus masuk acts[].entities; tidak ada yang boleh missing.',
    expected_json: `{
  "acts": [
  ...
  },
  {
    ...
    context_description:
      'Customer merevisi order dalam satu kalimat: batalkan es teh, ganti jadi es jeruk.',
    expected_json: `{
  "acts": [
  ...
  },
  {
    ...
    context_description:
      'Pending active bertanya "Mau pesan apa?"; user beralih ke pertanyaan ongkir (bukan jawaban confirmation) -> topic_switch.',
    expected_json: `{
  "acts": [
  ...
  },
  {
    ...
    context_description:
      'Opsi yang disajikan [X, Y] (N=2); user merujuk "ketiganya" (index 2) yang tidak ada -> mismatch.',
    expected_json: `{
  "acts": [],
  "unmatched_mentions": [],
  "topic_switch": false,
  ...
  },
  {
    user_message: 'iya',
    context_description:
      'Opsi [A, B, C, D] (N=4) disajikan; user hanya bilang "iya" secara ambigu -> clarification.',
    expected_json: `{
  "acts": [],
  "unmatched_mentions": [],
  "topic_switch": false,
  ...
  },
{
  ...
  },
  {
    ...
    context_description:
      'Customer hanya menyapa (greeting), tidak ada produk/nujuan order. Tidak ada act yang perlu dieksekusi; jawab ramah lewat reply_draft.',
    expected_json: `{
  "acts": [],
  "unmatched_mentions": [],
  "topic_switch": false,
  ...
  },
  {
    ...
    context_description:
      'Customer membatalkan/cancel produk "wortel" yang sebelumnya di keranjang. Intent=cancel, entity produk jejak; JANGAN ubatkan sebagai cart_update.',
    expected_json: `{
  "acts": [
  ...
  },
  {
    ...
    context_description:
      'Customer pesan sosis dengan varian warna "merah" dan size "L". Deskripsi varian (merah size L) wajib dicatat ke draft_cart_ops[].variant, bukan ke unmatched_mentions.',
    expected_json: `{
  "acts": [
  ...
  },
  {
    ...
    context_description:
      'Customer order 2 produk: kaos kaki (varian "hitam size M", qty 2) dan teh manis (tanpa varian, qty 1). Varian hanya dicatat pada draft_cart_op kaos kaki; teh manis tidak punya field variant.',
    expected_json: `{
  "acts": [
  ...
  },
  {
    ...
    context_description:
      'Customer pesan sosis varian "ayam size L" tanpa sebut qty eksplisit (qty default). Varian tetap dicatat ke draft_cart_ops[].variant.',
    expected_json: `{
  "acts": [
