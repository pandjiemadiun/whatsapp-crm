...
router.get('/', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to fetch bank accounts', error as Error);
...
router.post('/', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to create bank account', error as Error);
...
router.put('/:id', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to update bank account', error as Error);
...
router.delete('/:id', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to delete bank account', error as Error);
