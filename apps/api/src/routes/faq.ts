...
router.get('/', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to fetch FAQs', error as Error);
...
router.get('/search', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to search FAQs', error as Error);
...
router.get('/:id', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to fetch FAQ', error as Error);
...
router.post('/', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to create FAQ', error as Error);
...
router.put('/:id', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to update FAQ', error as Error);
...
router.delete('/:id', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    adapters.logger.error('Failed to delete FAQ', error as Error);
