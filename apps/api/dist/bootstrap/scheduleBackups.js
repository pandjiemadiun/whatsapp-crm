...
export function scheduleBackups() {
    ...
    cron.schedule(backupConfig.scheduleDaily, async () => {
        ...
        try {
            ...
            adapters.logger.error('[Backup Scheduler] Daily backup failed', error);
        }
    });
    ...
    cron.schedule(backupConfig.scheduleWeekly, async () => {
        ...
        try {
            ...
            adapters.logger.error('[Backup Scheduler] Weekly backup failed', error);
        }
    });
    ...
    cron.schedule('0 4 * * *', async () => {
        ...
        try {
            ...
            adapters.logger.error('[Backup Scheduler] Cleanup failed', error);
        }
    });
    adapters.logger.info('[Backup Scheduler] Started — daily 2AM, weekly Sun 3AM, cleanup 4AM');
}
//# sourceMappingURL=scheduleBackups.js.map