...
import { isDeadEnd, isUrgent, messageQueueService } from '../services/message-queue.service.js';
...
describe('CircuitBreakerService', () => {
    ...
    test('wrap: failure throws and records', async () => {
        ...
        await assert.rejects(cb.wrap(async () => {
...
describe('PresenceSimulatorService', () => {
    test('calculateDelay scales with word count', () => {
        ...
        const longDelay = presenceSimulatorService.calculateDelay(Array(50).fill('word').join(' '), store);
