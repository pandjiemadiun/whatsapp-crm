...
export class R2Adapter {
    ...
    async refreshImageUrl(url) {
        ...
        if (this.publicBaseUrl)
            return url; // public URL, permanen
        try {
    ...
    async uploadImage(buffer, folder) {
        ...
        try {
            ...
            (await this.getAdapters()).logger.error('R2 upload failed', error, { key });
    ...
    async deleteImage(key) {
        ...
        try {
            ...
            (await this.getAdapters()).logger.warn('R2 delete failed', error);
        }
    }
}
export const r2Adapter = new R2Adapter();
//# sourceMappingURL=r2.adapter.js.map