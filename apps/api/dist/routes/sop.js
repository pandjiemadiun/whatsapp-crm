...
const router = Router();
const VALID_CATEGORIES = ['order', 'komplain', 'retur', 'garansi', 'stok_habis'];
...
router.get('/', async (req, res) => {
    try {
        ...
        adapters.logger.error('Failed to fetch SOPs', error);
...
router.put('/:category', async (req, res) => {
    try {
        ...
        adapters.logger.error('Failed to update SOP', error);
