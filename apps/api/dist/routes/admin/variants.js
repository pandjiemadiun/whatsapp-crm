 ...
 */
router.get('/stores/:storeId/products/:productId/variants', asyncHandler(async (req, res) => {
 ...
 */
router.post('/stores/:storeId/products/:productId/variants', validateRequest(createVariantSchema, 'body'), async (req, res) => {
    try {
        const { storeId, productId } = req.params;
        ...
        adapters.logger.error('Failed to create variant', error);
 ...
 */
router.patch('/variants/:variantId', validateRequest(updateVariantSchema, 'body'), async (req, res) => {
    try {
        ...
        adapters.logger.error('Failed to update variant', error);
...
router.delete('/variants/:variantId', async (req, res) => {
    try {
        ...
        adapters.logger.error('Failed to delete variant', error);
