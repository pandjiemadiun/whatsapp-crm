...
// Coalescing window
const TEXT_COALESCE_MIN = 5000;
const TEXT_COALESCE_MAX = 15000;
const MEDIA_COALESCE_MIN = 10000;
const MEDIA_COALESCE_MAX = 15000;
...
export function isDeadEnd(text) {
 ...
 */
export function isDeadEndWithContext(text, lastAiMessage) {
    if (!isDeadEnd(text))
        return false;
...
export function isOrderFunnelContext(text) {
...
export class MessageQueueService {
     ...
     */
    async isDuplicate(storeId, messageId) {
