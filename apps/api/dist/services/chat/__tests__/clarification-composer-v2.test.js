...
describe('composeClarification — attempt 2 (FASE B2)', () => {
    ...
    it('attempt 2 expected_type=choice → output beda dari expected_type=affirmative', () => {
        const choiceMsg = composeClarification(makeClar({ expected_type: 'choice' }), 2);
        const affMsg = composeClarification(makeClar({ expected_type: 'affirmative' }), 2);
...
//# sourceMappingURL=clarification-composer-v2.test.js.map