...
describe('shadow-summary', () => {
    ...
    it('computeShadowSummary dengan mismatch', async () => {
        ...
        await storage.saveShadowEntry({ ...entryBase, store_id: 's1', mismatch: { replyDiffers: true, entitySetDiffers: false } });
        await storage.saveShadowEntry({ ...entryBase, store_id: 's1', mismatch: { replyDiffers: false, entitySetDiffers: false } });
...
//# sourceMappingURL=shadow-summary-v2.test.js.map